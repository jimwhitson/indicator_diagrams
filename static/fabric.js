...
(function(global) {
  ...
  if (fabric.nativeText) {
    fabric.warn('fabric.nativeText is already defined');
    return;
  }
  if (!fabric.Object) {
    fabric.warn('fabric.nativeText requires fabric.Object');
    return;
  }
   ...
   * @extends fabric.Object
   */
  fabric.nativeText = fabric.util.createClass(fabric.Object, /** @scope fabric.nativeText.prototype */ {
     ...
     * @param {String} text
     * @param {Object} [options]
     * @return {fabric.nativeText} thisArg
     */
    ...
    /**
     * Creates `stateProperties` list on an instance, and adds `fabric.nativeText` -specific ones to it
     ...
     */
    toString: function() {
      return '#<fabric.nativeText (' + this.complexity() +
    ...
    toSVG: function() {
      ...
      var svgTransform = ["translate(", this.left - 25, ", ", this.top + 5, ")"].join("");
      return [
  ...
  /**
   * Returns fabric.nativeText instance from an object representation
   * @static
   * @method fromObject
   * @param {Object} object to create an instance from
   * @return {fabric.nativeText} an instance
   */
  fabric.nativeText.fromObject = function(object) {
    return new fabric.nativeText(object.text, clone(object));
  };

  /**
   * Returns fabric.nativeText instance from an SVG element (<b>not yet implemented</b>)
   * @static
   * @method fabric.nativeText.fromElement
   * @return {fabric.nativeText} an instance
   */
  fabric.nativeText.fromElement = function(element) {
